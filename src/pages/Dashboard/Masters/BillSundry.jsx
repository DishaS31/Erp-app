...
export default function BillSundry() {
  ...
  const rowData = useMemo(
    () => [
      ...
      {
        name: "CESS (GST) OUTPUT A/C - Output",
        group: "",
        type: "Taxable Account",
        nature: "",
        status: "ACTIVE",
  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] px-10 py-4">
      ...
      <div className="flex justify-between items-start mb-4">
        <h1 className="text-[28px] font-extrabold text-black">Bill Sundry</h1>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <button
          onClick={() =>
            navigate("/company/dashboard/masters/bill-sundry/add")
          }
        ...
        <button
        onClick={() =>
            navigate("/company/dashboard/masters/bill-sundry/edit")
        }
        className="h-[36px] px-5 bg-primary text-white font-bold rounded-md text-tiny"
        >
        Edit
        ...
        <div className="relative" ref={addOnRef}>
            ...
            <button
                ...
                className="
                h-[36px] px-5 bg-primary text-white
