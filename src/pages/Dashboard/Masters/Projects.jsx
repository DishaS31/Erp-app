...
const columnDefs = useMemo(() => [
  ...
  // ASSETS (separate group, NOT merged)
  {
    headerName: "ASSETS",
    marryChildren: true,
    headerClass: "ag-header-cell", 
  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] px-10 py-4">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <button
          onClick={() =>
            navigate("/company/dashboard/masters/projects/add")
          }
        ...
        <button
          onClick={() =>
            navigate("/company/dashboard/masters/projects/edit/1")
          }
          className="h-[36px] px-5 bg-primary text-white font-bold rounded-md text-tiny"
        >
          Edit
        ...
        <button
        onClick={() =>
            navigate("/company/dashboard/masters/project-groups")
        }
        className="h-[36px] px-5 bg-primary text-white font-bold rounded-md text-tiny"
        >
        Groups
