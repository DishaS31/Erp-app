...
export default function CostCentre() {
  ...
  const columnDefs = useMemo(
    () => [
      ...
      { headerName: "COST CENTRE", field: "name", flex: 2 },
      { headerName: "ALIAS", field: "alias", flex: 2 },
      { headerName: "GROUP", field: "group", flex: 2 },
      { headerName: "OP. BALANCE", field: "balance", flex: 1 },
      { headerName: "DR/CR", field: "type", flex: 1 },
  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] px-10 py-4">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <button
          onClick={() =>
            navigate("/company/dashboard/masters/cost-centre/add")
          }
        ...
        <button
          onClick={() =>
            navigate("/company/dashboard/masters/cost-centre/edit")
          }
          className="h-[36px] px-5 bg-primary text-white font-bold rounded-md text-tiny"
        >
          Edit
        ...
        <button
        onClick={() =>
            navigate("/company/dashboard/masters/cost-centre-groups")
        }
        className="h-[36px] px-5 bg-primary text-white font-bold rounded-md text-tiny"
        >
        Groups
