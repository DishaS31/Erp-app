...
export default function EditCostCentreGroup() {
    ...
    <div className="min-h-screen bg-[#f5f6f8] px-10 py-6">
      ...
      <div className="max-w-[850px]">
        ...
        <div className="flex items-center gap-4 ml-[180px]">
          <button className="h-[40px] px-8 bg-primary text-white font-bold rounded-md">
            SAVE
          </button>

          <button
            onClick={() => navigate(-1)}
            className="h-[40px] px-8 bg-[#2d3748] text-white font-bold rounded-md"
          >
            QUIT
          </button>
        </div>
