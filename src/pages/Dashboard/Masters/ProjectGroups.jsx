...
export default function ProjectGroups() {
 ...
 const rowData = useMemo(() => [
  ...
  const columnDefs = useMemo(() => [
    ...
    { headerName: "ALIAS", field: "alias", flex: 2 },
    { headerName: "UNDER GROUP", field: "underGroup", flex: 2 },
  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] px-10 py-4">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <button
          onClick={() => navigate("/company/dashboard/masters/project-groups/add")}
        ...
        <button
          onClick={() => navigate("/company/dashboard/masters/project-groups/edit/1")}
          className="h-[36px] px-5 bg-primary text-white font-bold rounded-md text-tiny"
        >
          Edit
        </button>
        ...
        <button
          onClick={() => navigate("/company/dashboard/masters/projects")}
          className="h-[36px] px-5 bg-primary text-white font-bold rounded-md text-tiny"
        >
          Projects
        </button>
        ...
        <div className="flex items-center justify-between px-4 py-2 border-t bg-white text-[14px]">
          <div className="flex items-center gap-3">
            ...
            <select className="ml-3 h-[28px] px-2 border rounded-md font-semibold">
             ...
             <span className="ml-4 text-[#525b75]">
