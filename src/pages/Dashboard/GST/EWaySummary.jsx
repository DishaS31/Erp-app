...
export default function EWaySummary() {
...
const columnDefs = useMemo(() => [
  ...
  { headerName: "EWB NO.", field: "ewbNo", flex: 1 },
  ...
  { headerName: "EWB STATUS", field: "status", flex: 1 },
  { headerName: "EWB EXPIRY", field: "expiry", flex: 1 },
  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] px-10 py-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <div className="flex items-center bg-white border border-[#cfd6e4] rounded-md overflow-hidden h-[38px]">
            ...
            <select className="px-4 h-full outline-none text-[13px] font-bold bg-white">
              <option>ALL RECORDS (MANDATORY)</option>
            </select>
          </div>

          <button className="h-[38px] px-4 bg-primary text-white font-bold rounded-md text-[13px]">
            Generate E-WAY
          </button>
            ...
            {openAddOn && (
                ...
                <button className="w-full text-left px-4 py-3 hover:bg-gray-100 text-[14px] text-gray-600">
                    Download Json
                </button>
                </div>
            )}
            ...
            {openFilter && (
                ...
                <button className="w-full text-left px-4 py-3 hover:bg-gray-100 text-[14px] text-gray-600 border-t">
                    Another action
                </button>
                <button className="w-full text-left px-4 py-3 hover:bg-gray-100 text-[14px] text-gray-600 border-t">
                    Something else here
      ...
      <div className="bg-white border rounded-md overflow-hidden">
        ...
        {/* ================= GRID FILTER BAR ================= */}
        <div className="bg-[#f3f4fb] border border-b-0 px-4 py-2 flex items-center gap-3 text-[13px] font-bold">
