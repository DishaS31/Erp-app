...
export default function MemorandumVoucher() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] px-10 py-4">
      ...
      <div className="flex justify-between mb-4">
        <h1 className="text-[28px] font-extrabold text-black">Memorandum Voucher</h1>
        ...
        <div className="flex items-center mb-3">
          ...
          <div className="ml-auto flex gap-3">
           ...
           <div className="relative" ref={addOnsRef}>
             ...
             {showAddOns && (
                <div className="absolute right-0 mt-2 w-[200px] bg-white border border-[#cfd6e4]  shadow-md z-50 overflow-hidden rounded-md">

                    {/* Item 1 */}
                    <button
                    className="w-full text-left px-4 py-3 text-tiny text-[#374151] hover:bg-[#f3f6fb]"
                    onClick={() => {
                        setShowAddOns(false);
                        // action logic later
                    }}
