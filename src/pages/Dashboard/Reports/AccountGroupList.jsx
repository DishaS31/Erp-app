...
const columnDefs = useMemo(() => [
  ...
  {
    headerName: "",          // 🔴 BLANK HEADER — VERY IMPORTANT
    field: "balanceType",    // DR / CR
    flex: 1,
    cellClass: "font-bold",
  },
], []);
    ...
    <div className="min-h-screen bg-[#f5f6f8] px-10 py-4">
     ...
     <button
      ...
      {/* ADD ONS DROPDOWN */}
        ...
        <button
        onClick={() => navigate(-1)}
        className="h-[36px] px-5 border border-primary text-primary font-bold rounded-md text-tiny"
        >
        « Back
        </button>
      ...
      <div className="mt-2 flex items-center gap-2 text-[13px] font-semibold text-gray-700">
        <input type="checkbox" />
        Consolidated In All Branches
      </div>
      <div className="mt-2 italic text-[15px] mb-4">
      ...
      {/* ================= GRID ================= */}
        ...
        <input
            ...
            className="h-[28px] px-3 border rounded-md outline-none w-[220px]"
        />

        <select className="h-[28px] px-2 border rounded-md font-semibold">
            <option>ACCOUNT</option>
             <option>Op. Balance</option>
            <option>DEBIT</option>
