...
const accounts = [
  "ADV SHIVAM",
  "Aicountly Interactive Services Pvt. Ltd.",
  "AKAI KARAOKE EMI H",
  "ASSET RESERVE AXIS",
  "BABU RAM",
  "BAJAJ FINERSV",
        ...
        <div className="bg-white w-[900px] rounded-xl shadow-xl p-6">
          ...
          <div className="grid grid-cols-2 gap-6 mb-4">
            ...
            >
                ...
                <option>Bill Sundry Ledger</option>
          ...
          {/* ACCOUNT SEARCH */}
         <div ref={accountBoxRef} className="relative mb-5">
        <label className="text-[13px] font-bold text-gray-700">
            Account
        </label>
...
<div className="ml-auto flex items-center gap-4 text-[13px] font-semibold">
  ...
  <input
    type="checkbox"
    checked={showBranchCol}
    onChange={(e) => setShowBranchCol(e.target.checked)}
  />
...
<label className="flex gap-2">
  <input
    type="checkbox"
    checked={showMemorandumCol}
    onChange={(e) => setShowMemorandumCol(e.target.checked)}
  />
  Memorandum
</label>
...
<div className="flex justify-between italic mb-3 text-[15px]">
  <div>
    Account: <span className="font-bold">{accountSearch}</span>
  </div>
  <div>
    Opening Balance: <span className="font-bold">₹0.00 DR</span>
  </div>
</div>
...
<div className="flex items-center gap-3 px-3 py-2 border-b bg-white text-[13px]">
  ...
  <div className="ml-auto bg-[#fff7e6] px-3 py-1 rounded-md font-semibold">
    Filter Mode : Current Page
  </div>
</div>
...
{/* ================= TOTALS ================= */}
<div className="flex justify-between italic mt-3 px-2">
  <div>Total Debit: <b>₹0.00</b></div>
  <div>Total Credit: <b>₹0.00</b></div>
  <div>Closing Balance: <b>₹0.00 DR</b></div>
</div>
