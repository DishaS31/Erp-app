...
export default function AccountWiseBillStatement() {
...
const rowData = [
  ...
  {
    account: "Business Support Services",
    receivable: "",
    payable: "",
    gross: "₹0.00 DR",
    undefined: "₹19,82,211.00 CR",
    net: "₹19,82,211.00 CR",
    ledger: "₹19,82,211.00 CR",
  },
  {
    account: "APICAP SCIENTIFIC",
    receivable: "",
    payable: "",
    gross: "₹0.00 DR",
    undefined: "₹19,82,211.00 DR",
    net: "₹19,82,211.00 DR",
    ledger: "₹19,82,211.00 DR",
  },
  {
  ...
  <div className="min-h-screen bg-[#f5f6f8] px-10 py-4">
    ...
    <div className="bg-white border border-t-0 rounded-b-md overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-t text-[14px]">
        ...
        <div>
          Displaying 1 to 10 of 14 items.
        </div>
      </div>
